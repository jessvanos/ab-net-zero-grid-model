...
Ren_Curtail_Gen_save <- function(CaseName) {
  ...
  GGSave_Loc_hourly(CaseName,"2045 4 month sum renewable curtail (Stacked Area + price) 1",FourMonthSummary_rCurtail(2045,01,04,07,10,BC),100)
  GGSave_Loc_hourly(CaseName,"2045 4 month sum renewable curtail (Stacked Area + price) 2",FourMonthSummary_rCurtail(2045,02,05,08,11,BC),100)
  GGSave_Loc_hourly(CaseName,"2045 4 month sum renewable curtail (Stacked Area + price) 3",FourMonthSummary_rCurtail(2045,03,06,09,12,BC),100)
