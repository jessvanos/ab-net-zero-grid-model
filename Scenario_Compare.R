...
{ # Available Fonts for plotting, can choose different one and change Plot_Text if needed
  ...
  { 
    ...
    colours3c = c("Net Imports"=cOL_IMPORT,"Coal"=cOL_COAL, "Cogen"=cOL_COGEN, 
                 ...
                 "Hydro"=cOL_HYDRO, "Other"=cOL_OTHER, "Wind"=cOL_WIND, 
                 "Solar"=cOL_SOLAR, "Storage"=cOL_STORAGE,
                 "NGCC_CCUS"=cOL_NGCC_CCS)
    
    
    colours3d = c("Net Imports"=cOL_IMPORT,"Coal"=cOL_COAL, "Cogen"=cOL_COGEN, 
                  "Coal-to-Gas"=cOL_NGConv,"H2SC"=cOL_SCGT_H2,"Hydrogen Combined Cycle"=cOL_NGCC_H2,
                  "NGCC+CCUS"=cOL_NGCC_CCS,
                  "NGSC"=cOL_SCGT, "NGCC"=cOL_NGCC, 
                  "Hydro"=cOL_HYDRO, "Other"=cOL_OTHER, "Wind"=cOL_WIND, 
                  "Solar"=cOL_SOLAR, "Storage"=cOL_STORAGE)
    ...
    colours3b = c("Net Imports"=cOL_IMPORT,"Coal"=cOL_COAL, "Cogeneration"=cOL_COGEN, 
                  ...
                  "Natural Gas Simple Cycle"=cOL_SCGT, "Natural Gas Combined Cycle"=cOL_NGCC, 
                  "Hydro"=cOL_HYDRO, "Other"=cOL_OTHER, "Wind"=cOL_WIND, 
                  "Solar"=cOL_SOLAR, "Storage"=cOL_STORAGE,"Natural Gas Combined Cycle + CCUS"=cOL_NGCC_CCS)
    ...
    colours5b = c("Cogeneration"=cOL_COGEN, 
                 "Coal-to-Gas"=cOL_NGConv,"Hydrogen Simple Cycle"=cOL_SCGT_H2,
                 "Natural Gas Combined Cycle + CCS"=cOL_NGCC_CCS,"Natural Gas Combined Cycle CCS Retrofit"=cOL_NGCC_CCS,
                 "Natural Gas Simple Cycle"=cOL_SCGT, "Natural Gas Combined Cycle"=cOL_NGCC, 
                 "Hydro"=cOL_HYDRO, "Other"=cOL_OTHER, "Wind"=cOL_WIND, 
                 "Solar"=cOL_SOLAR,  "Storage"=COL_Battery, 
                 "Nuclear"=cOL_NUCLEAR
    )
    
    Patterns5b = c("Cogeneration"="none", 
                  "Coal-to-Gas"="stripe","Hydrogen Simple Cycle"="none",
                  "Natural Gas Combined Cycle + CCS"="none","Natural Gas Combined Cycle CCS Retrofit"="stripe",
                  "Natural Gas Simple Cycle"="none", "Natural Gas Combined Cycle"="none", 
                  "Hydro"="none", "Other"="none", "Wind"="none", 
                  "Solar"="none",  "Storage"="none", 
    ...
    colours5c = c("Cogeneration"=cOL_COGEN,"Coal"=cOL_COAL,
                  "Coal-to-Gas"=cOL_NGConv,"Hydrogen Simple Cycle"=cOL_SCGT_H2,
                  "Natural Gas Combined Cycle + CCS"=cOL_NGCC_CCS,"Natural Gas Combined Cycle CCS Retrofit"=cOL_NGCC_CCS,
                  "Natural Gas Simple Cycle"=cOL_SCGT, "Natural Gas Combined Cycle"=cOL_NGCC, 
                  "Hydro"=cOL_HYDRO, "Other"=cOL_OTHER, "Wind"=cOL_WIND, 
    ...
    Patterns5c = c("Cogeneration"="none", "Coal"="none",
                   "Coal-to-Gas"="stripe","Hydrogen Simple Cycle"="none",
                   "Natural Gas Combined Cycle + CCS"="none","Natural Gas Combined Cycle CCS Retrofit"="stripe",
                   "Natural Gas Simple Cycle"="none", "Natural Gas Combined Cycle"="none", 
                   "Hydro"="none", "Other"="none", "Wind"="none", 
    ...
    colours5d = c("Cogen"=cOL_COGEN,"Coal"=cOL_COAL,
                  "Coal-to-Gas"=cOL_NGConv,"H2SC"=cOL_SCGT_H2,
                  "NGCC+CCUS"=cOL_NGCC_CCS,"NGCC+CCUS Retrofit"=cOL_NGCC_CCS,
                  "NGSC"=cOL_SCGT, "NGCC"=cOL_NGCC, 
                  "Hydro"=cOL_HYDRO, "Other"=cOL_OTHER, "Wind"=cOL_WIND, 
                  "Solar"=cOL_SOLAR,  "Storage"=COL_Battery, 
                  "Nuclear"=cOL_NUCLEAR
    ...
    Patterns5d = c("Cogen"="none", "Coal"="none",
                   "Coal-to-Gas"="stripe","H2SC"="none",
                   "NGCC+CCUS"="none","NGCC+CCUS Retrofit"="stripe",
                   "NGSC"="none", "NGCC"="none", 
                   "Hydro"="none", "Other"="none", "Wind"="none", 
                   "Solar"="none",  "Storage"="none", 
                   "Nuclear"="none"
  ...
  # Scenario colors with historic
   sn_colors_l <-c("Draft CER"=COL_CER,
                   ...
                   "Current Policy No ITCs"= COL_noITC,
                   "Draft CER No ITCs"=COL_noITC_CER,
                   "Absolute Zero" = COL_Az,
                   "No H2 Absolute Zero" = COL_AZ_noH2,
                   "No Emissions Credits" = COL_noEPC,
                   "30% Credit Value" = COL_30EPC,
                   "50% Credit Value" = COL_50EPC,
                   "70% Credit Value" = COL_70EPC,
   ...
   sn_line_l <-c("Draft CER"=1,
                 ...
                 "TIER 2050" = 1,
                 "TIER 2035" = 1,
                 "Current Policy No ITCs"= 1,
                 "Draft CER No ITCs"=1,
                 "Absolute Zero" = 1,
                 "No H2 Absolute Zero"=1,
                 "No Emissions Credits" = 5,
                 "30% Credit Value" = 2,
                 "50% Credit Value" = 3,
                 "70% Credit Value" = 4,
                 "CP_txmod" = 1,
   ...
   sn_shape_l <-c("Draft CER"=16,
                    ...
                    "TIER 2050" = 8,
                    "TIER 2035" = 17,
                    "Current Policy No ITCs"=0,
                    "Draft CER No ITCs"=1,
                    "Absolute Zero" = 24,
                    "No H2 Absolute Zero" = 25,
                    "No Emissions Credits"=7,
                    "30% Credit Value" = 9,
                    "50% Credit Value" = 12,
                    "70% Credit Value" = 14,
                    "No CCUS"=11
   ...
   sn_line_ITC <-c("Draft CER"=1,
                  "Current Policy"=1,
                  "Current Policy No ITCs"=2,
                  "Draft CER No ITCs"=2)
                  
   sn_col_ITC <-c("Draft CER"="black",
                   "Current Policy"="gray50",
                   "Current Policy No ITCs"="gray50",
                   "Draft CER No ITCs"="black")
   
   
   # Scenarios all highlight CP
   sn_colors_CP <-c("Draft CER"="gray70",
                    "Current Policy"="black",
                    "Emissions Limit"="gray75",
                    "TIER 2050" = "gray90",
                    "TIER 2035" = "gray80",
                    "Current Policy No ITCs"="gray85",
                    "Draft CER No ITCs"="gray60",
                    "No Emissions Credits"="gray65",
                    "30% Credit Value" = "gray77",
                    "50% Credit Value" = "gray72",
                    "70% Credit Value" = "gray82",
                    "No CCUS"="gray88"
   )
   
   sn_line2_CP <-c("Draft CER"=1,
                  "Current Policy"=1,
                  "Emissions Limit"=1,
                  "TIER 2050" = 1,
                  "TIER 2035" = 1,
                  "Current Policy No ITCs"=1,
                  "Draft CER No ITCs"=1,
                  "No Emissions Credits" = 1,
                  "30% Credit Value" = 1,
                  "50% Credit Value" = 1,
                  "70% Credit Value" = 1,
                  "No CCUS"=1
   )
   sn_size_CP <-c("Draft CER"=1,
                   "Current Policy"=2,
                   "Emissions Limit"=1,
                   "TIER 2050" = 1,
                   "TIER 2035" = 1,
...
## Change "text" to modify plot names.
################################################################################
{
# Compare pool prices
...
GGSave_Loc_custom(CaseName,"Cumulative Emissions Compare noncogen",AnnualEm_Cum_COMPARE("l", "n"),12,6)
GGSave_Loc_custom(CaseName,"Compare final emissions 2",AnnualEm_Cum_Dots("l", "n"),12,8)

# Capacity changes
GGSave_Loc_custom(CaseName,"Total Capacity Added 2",Total_Cap_Add_COMPARE("l"),12,5)
...
GGSave_Loc_custom(CaseName,"Annual Capacity Years",Annual_Cap_COMPARE("l"),14,6)

# Annual bar plot capacity changes
GGSave_Loc_custom(CaseName,"Annual Cap Changes",TotalCapChange_Compare(),14,5)
GGSave_Loc_custom(CaseName,"Net Annual Cap Changes",NetCapChange_Compare(),14,5)

GGSave_Loc_custom(CaseName,"Annual Cap Changes EPCs",TotalCapChange_Compare(),14,8)
#GGSave_Loc_custom(CaseName,"Net Annual Cap ChangesEPCs",NetCapChange_Compare(),14,8)
...
GGSave_Loc_custom(CaseName,"Avg CF",Annual_CF_group(),12,4)
GGSave_Loc_custom(CaseName,"Avg CF EPC",Annual_CF_group(),14,5)


# Total Gen Cumulative
...
GGSave_Loc_custom(CaseName,"Cumulative Annual Cost",AnnualCost_Cum_COMPARE("l",emissions_include="Y"),12,8)
GGSave_Loc_custom(CaseName,"Cumulative Annual Cost rel",AnnualCost_Cum_rel_COMPARE("l",emissions_include="Y"),12,8)
...
# PLOTS FOR YEAR BY YEAR, BREAK UP BY GROUP
{
  ...
  GGSave_Loc_custom(CaseName,"Annual Capacity Renewable",Annual_Cap_group(name_type="l",list_groups=renew),14,4)
  GGSave_Loc_custom(CaseName,"Annual Capacity All Fossil",Annual_Cap_group(name_type="l",list_groups=all_fossil),14,4)
  ...
  GGSave_Loc_custom(CaseName,"Annual Generation Renewable",Annual_Gen_group(name_type="l",list_groups=renew),14,4)
  GGSave_Loc_custom(CaseName,"Annual Generation All Fossil",Annual_Gen_group(name_type="l",list_groups=all_fossil),14,4)
  ...
  GGSave_Loc_custom(CaseName,"Annual Gen CCNG",Annual_Gen_group(name_type="l",list_groups=c("Natural Gas Combined Cycle + CCS", "Natural Gas Combined Cycle")),14,5)
  GGSave_Loc_custom(CaseName,"Annual Generation Solar",Annual_Gen_group(name_type="l",list_groups=c("Solar")),14,6)
  
  GGSave_Loc_custom(CaseName,"Annual Emissions non-cogen",Annual_Em_group(name_type="l",list_groups=em_groups,shorten_names=TRUE),12,6)
  ...
  # STACKED AREAS
  GGSave_Loc_custom(CaseName,"Annual Generation All Area",Annual_Gen_group_area(name_type="l",list_groups=all_groups,nrg_include=FALSE),14,5)
  GGSave_Loc_custom(CaseName,"Annual Generation All Area EPC B",Annual_Gen_group_area(name_type="l",list_groups=all_groups,nrg_include=FALSE,EPC_rename=TRUE),14,4)
  ...
  GGSave_Loc_custom(CaseName,"Annual Capacity All Area",Annual_Cap_group_area(name_type="l",list_groups=all_groups,nrg_include=FALSE),14,5)
  GGSave_Loc_custom(CaseName,"Annual Capacity All Area EPC",Annual_Cap_group_area(name_type="l",list_groups=all_groups,nrg_include=FALSE,EPC_rename=TRUE),14,5)
  
  
  GGSave_Loc_custom(CaseName,"Annual Capacity All Area EPC B",Annual_Cap_group_area(name_type="l",list_groups=all_groups,nrg_include=FALSE,EPC_rename=FALSE),8,4)
  GGSave_Loc_custom(CaseName,"Annual Generation All Area EPC B",Annual_Gen_group_area(name_type="l",list_groups=all_groups,nrg_include=FALSE,EPC_rename=FALSE),8,4)
...
# COMPARE METRICS
  ...
  GGSave_Loc_custom(CaseName,"Total Emissions Diff rel to CP",Em_Diff_COMPARE("l",base_case,em_diff_groups),12,5)
  ...
  # EPC PLOTS
  epc_cap_groups1 <- c("Hydrogen Simple Cycle","Hydrogen Combined Cycle",
                  "Natural Gas Combined Cycle + CCS", "Natural Gas Simple Cycle", "Natural Gas Combined Cycle", 
                  "Hydro", "Other", "Wind", "Solar", "Storage")
  ...
  gen_all_groups <- c("Coal", "Cogeneration","Coal-to-Gas","Hydrogen Simple Cycle","Hydrogen Combined Cycle",
                      "Natural Gas Combined Cycle + CCS", "Natural Gas Simple Cycle", "Natural Gas Combined Cycle", 
                      "Hydro", "Other", "Wind", "Solar", "Imports","Exports")
  ...
  EPC_colors <-c("Current Policy"="black",
                   "No Emissions Credits"="black",
                   "30% Credit Value" = "black",
                   "50% Credit Value" = "black",
                   "70% Credit Value" = "black"
  )
  GGSave_Loc_custom(CaseName,"Capacity based on EPC select",Annual_Cap_group_dots(epc_cap_groups,TRUE),12,8)
  GGSave_Loc_custom(CaseName,"All Capacity based on EPC2",Annual_Cap_group_dots(epc_cap_groups1,TRUE),12,8)
  GGSave_Loc_custom(CaseName,"Gen based on EPC V2",Cum_Gen_group_dots(TRUE,gen_all_groups),12,8)
  GGSave_Loc_custom(CaseName,"CF based on EPC",CF_group_dots(TRUE),12,8)
  GGSave_Loc_custom(CaseName,"Value by plant",value_group_dots(FALSE),12,8)
  #GGSave_Loc_custom(CaseName,"Avg bid based on EPC",Avg_Bid_Cost_dots(TRUE),12,8)
  
  
  GGSave_Loc_custom(CaseName,"EPC Emissions Compare noncogen2",AnnualEm_COMPARE("l", "n",FALSE),12,6)
  
  
  # CCS PLOTS
  GGSave_Loc_custom(CaseName,"CCUS vs annual emissions",AnnualEm_vs_group("l",resfilter_type="Natural Gas Combined Cycle + CCS"),12,6)
  GGSave_Loc_custom(CaseName,"Wind vs annual emissions",AnnualEm_vs_group("l",resfilter_type="Wind"),12,6)
  GGSave_Loc_custom(CaseName,"NGCC vs annual emissions",AnnualEm_vs_group("l",resfilter_type="Natural Gas Combined Cycle"),12,6)
  GGSave_Loc_custom(CaseName,"NGSC vs annual emissions",AnnualEm_vs_group("l",resfilter_type="Natural Gas Simple Cycle"),12,6)
  GGSave_Loc_custom(CaseName,"Solar vs annual emissions",AnnualEm_vs_group("l",resfilter_type="Solar"),12,6)
  
  GGSave_Loc_custom(CaseName,"CCUS vs annual emissions pres",AnnualEm_vs_group("l",resfilter_type="Natural Gas Combined Cycle + CCS"),10,6)
